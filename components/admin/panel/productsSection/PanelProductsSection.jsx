      ...
      <div className="flex flex-col w-full py-4 px-8 gap-6">
        ...
        <div className="flex flex-col w-full h-full bg-white rounded-md px-4 py-4">
          ...
          <div className="flex flex-row justify-start items-center gap-2">
            <button className="bg-blue-700 p-1.5 font-medium text-white rounded-md flex flex-row justify-start items-center gap-1.5 w-full max-w-48 border border-blue-700"
          ...
          {/* Listed Products */}
          <div className="mt-4 overflow-y-scroll max-h-[430px] bg-white grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-items-center scrollbar-thin gap-4">
            <PanelProductsListCard setShowDetail={setShowDetail} />
            <PanelProductsListCard setShowDetail={setShowDetail} />
            <PanelProductsListCard setShowDetail={setShowDetail} />
            <PanelProductsListCard setShowDetail={setShowDetail} />
            <PanelProductsListCard setShowDetail={setShowDetail} />
          ...
          {showDetail && <ProductVisualization setShowDetail={setShowDetail} />}
