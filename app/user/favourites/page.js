...
const FavouritesPage = ({ products = elements }) => {
  return (
    <div className="p-4 xs:p-8 w-full flex flex-col justify-center items-center">
      <div className="w-full flex flex-col justify-center items-start max-w-screen-xl space-y-10">
        ...
        <div className="w-full space-y-20">
          {products ? (
                ...
                {products.map((item, index) => (
                  <div
                    ...
                    className={`w-full bg-white py-4 border-b sm:border-r ${
                      ...
                      index >= products.length - 2 ? "sm:border-b-0" : ""
                    } md:hidden `}
                  >
                ...
                {products.map((item, index) => (
                  <div
                    ...
                    className={`w-full bg-white py-4 px-1 border-b border-r ${
                      ...
                      index >= products.length - 3 ? "sm:border-b-0" : ""
                    } hidden md:block`}
                  >
                    <FavouriteProductCard />
                  </div>
            ...
            <div className="flex flex-row w-full items-center justify-center text-black/50 text-lg xs:text-xl sm:text-2xl md:text-3xl text-center">
